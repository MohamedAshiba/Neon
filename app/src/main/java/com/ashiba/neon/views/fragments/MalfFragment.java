...
import static com.ashiba.neon.utils.Const.URL_JSON_MALAF;

/**
 * A simple {@link Fragment} subclass.
 */
public class MalfFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mView = inflater.inflate(R.layout.fragment_malf, container, false);
        bottom_post_list = new ArrayList<>();

        bottomPostRecyclerView = mView.findViewById(R.id.malf_post_recycler_view);
        ...
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                ...
                Log.v("malfFragmentTest", String.valueOf(page));
    ...
    private void makeJsonObjReq() {
        ...
        JsonObjectRequest stringRequest = new JsonObjectRequest(Request.Method.GET, URL_JSON_MALAF, new Response.Listener<JSONObject>() {
            @Override
    ...
    private String urlWithPages(int page) {
        String url = "https://neonsci.com/api/get_category_posts/?id=13&page=" + page;
        return url;
    }
