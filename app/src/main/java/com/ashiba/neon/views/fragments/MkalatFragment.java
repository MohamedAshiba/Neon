...
import static com.ashiba.neon.utils.Const.URL_JSON_MKALAT;

/**
 * A simple {@link Fragment} subclass.
 */
public class MkalatFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mView = inflater.inflate(R.layout.fragment_mkalat, container, false);
        bottom_post_list = new ArrayList<>();

        bottomPostRecyclerView = mView.findViewById(R.id.mkalat_post_recycler_view);
        ...
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                ...
                Log.v("MkalatFragmentTest", String.valueOf(page));
    ...
    private void makeJsonObjReq() {
        ...
        JsonObjectRequest stringRequest = new JsonObjectRequest(Request.Method.GET, URL_JSON_MKALAT, new Response.Listener<JSONObject>() {
            @Override
    ...
    private String urlWithPages(int page) {
        String url = "https://neonsci.com/api/get_category_posts/?id=22&page=" + page;
        return url;
    }
