...
import static com.ashiba.neon.utils.Const.URL_JSON_HAGS;

/**
 * A simple {@link Fragment} subclass.
 */
public class HagsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mView = inflater.inflate(R.layout.fragment_hags, container, false);
        bottom_post_list = new ArrayList<>();

        bottomPostRecyclerView = mView.findViewById(R.id.hags_post_recycler_view);
    ...
    private void makeJsonObjReq() {
        ...
        JsonObjectRequest stringRequest = new JsonObjectRequest(Request.Method.GET, URL_JSON_HAGS, new Response.Listener<JSONObject>() {
            @Override
    ...
    private String urlWithPages(int page) {
        String url = "https://neonsci.com/api/get_category_posts/?id=24&page=" + page;
        return url;
    }
