...
import static com.ashiba.neon.utils.Const.URL_JSON_HEDROGENA;

/**
 * A simple {@link Fragment} subclass.
 */
public class HedrogenaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mView = inflater.inflate(R.layout.fragment_hedrogena, container, false);
        bottom_post_list = new ArrayList<>();

        bottomPostRecyclerView = mView.findViewById(R.id.hedrogena_post_recycler_view);
        ...
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                ...
                Log.v("HedrogenaFragmentTest", String.valueOf(page));
    ...
    private void makeJsonObjReq() {
        ...
        JsonObjectRequest stringRequest = new JsonObjectRequest(Request.Method.GET, URL_JSON_HEDROGENA, new Response.Listener<JSONObject>() {
            @Override
    ...
    private String urlWithPages(int page) {
        String url = "https://neonsci.com/api/get_category_posts/?id=25&page=" + page;
        return url;
    }
